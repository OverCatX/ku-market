    ...
    <section className="py-20 px-6 md:px-20 bg-gray-50 border-t border-gray-200">
      ...
      >
        <div className="text-center mb-16">
          <h2 className="font-header text-4xl md:text-5xl text-[#69773D] mb-4">
            What is KU Market?
          </h2>
          <p className="font-body text-gray-700 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
            KU Market is a campus marketplace where students can buy, sell, and trade items easily.
            Connect with fellow students, discover great deals, and enjoy a smarter way to shop on campus.
          </p>
        </div>
