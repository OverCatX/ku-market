  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        const errorMessage =
          errorData.error || errorData.message || "Failed to upload item";
      ...
      toast.success(
        "Item added successfully! It will be reviewed by admin before being published."
      );
        ...
        >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#69773D] resize-none"
              rows={4}
